...
func DocumentedV1Operations() []Operation {
	...
	appendOperation(http.MethodPost, "/v1/instance/{instance}/chat/presence", "/v1/instance/{instance}/chat/read-messages", "/v1/chat/markMessageAsRead/{instance}", "/v1/chat/sendPresence/{instance}", "/v1/chat/whatsappNumbers/{instance}", "/v1/instance/{instance}/chat/fetchProfilePictureUrl", "/v1/chat/fetchProfilePictureUrl/{instance}", "/v1/instance/{instance}/chat/findContact", "/v1/chat/findContact/{instance}", "/v1/instance/{instance}/contact/find")
